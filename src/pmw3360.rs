...
impl MotionReport {
    const INDEX_DELTA_X_L: usize = 2;
    const INDEX_DELTA_X_H: usize = 3;
    const INDEX_DELTA_Y_L: usize = 4;
    const INDEX_DELTA_Y_H: usize = 5;
    pub fn new(report: [u8; 12]) -> Self {
        MotionReport { report }
    }
    pub fn dx(&self) -> i16 {
        (((self.report[Self::INDEX_DELTA_X_H] as u16) << 8)
            | (self.report[Self::INDEX_DELTA_X_L] as u16)) as i16
    }
    pub fn dy(&self) -> i16 {
        (((self.report[Self::INDEX_DELTA_Y_H] as u16) << 8)
            | (self.report[Self::INDEX_DELTA_Y_L] as u16)) as i16
    }
}
...
pub const CONFIG2: u8 = 0x10;
pub const ANGLE_TUNE: u8 = 0x11;
pub const FRAME_CAPTURE: u8 = 0x12;
pub const SROM_ENABLE: u8 = 0x13;
pub const RUN_DOWNSHIFT: u8 = 0x14;
pub const REST1_RATE_LOWER: u8 = 0x15;
pub const REST1_RATE_UPPER: u8 = 0x16;
pub const REST1_DOWNSHIFT: u8 = 0x17;
pub const REST2_RATE_LOWER: u8 = 0x18;
pub const REST2_RATE_UPPER: u8 = 0x19;
pub const REST2_DOWNSHIFT: u8 = 0x1A;
pub const REST3_RATE_LOWER: u8 = 0x1B;
pub const REST3_RATE_UPPER: u8 = 0x1C;
...
pub const LIFTCUTOFF_TUNE2: u8 = 0x65;
